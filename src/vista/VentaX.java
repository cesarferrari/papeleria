 ...
 * @author julio
 */
public class VentaX extends javax.swing.JFrame {
...
this.txt_serie.setEnabled(false);
   ...
   int jp= JOptionPane.showConfirmDialog(this,"desea cancelar la venta","confirmar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    try {
        ...
        Logger.getLogger(VentaX.class.getName()).log(Level.SEVERE, null, ex);
    }
    return resto;
    }
   ...
   public void actualiza_precio(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentaX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
